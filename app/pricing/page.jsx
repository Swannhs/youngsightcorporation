                              ...
                              <div className="mega-menu-pages-single">
                                <div className="mega-menu-pages-single-inner">
                                  ...
                                  <div className="mega-menu-list">
                                    ...
                                    <Link className="active" href="/pricing">Pricing plan</Link>
                ...
                <div className="row">
                  <div className="col-lg-12">
                    <div className="tj-page-header-content text-center">
                      <h1 className="tj-page-title">Pricing</h1>
                ...
                <div className="row">
                  <div className="col-12">
                    <div className="sec-heading text-center">
                      <span className="sub-title wow fadeInUp" data-wow-delay=".1s"><i className="tji-box" />Pricing plan</span>
                      <h2 className="sec-title title-anim">Our Pricing <span>Plan.</span></h2>
                    </div>
                  </div>
                </div>
