                              ...
                              <div className="mega-menu-pages-single">
                                <div className="mega-menu-pages-single-inner">
                                  ...
                                  <div className="mega-menu-list">
                                    ...
                                    <a className="active" href="/history">Our history <span className="mega-menu-badge tj-zoom-in-out-anim mega-menu-badge-hot ">HOT</span></a>
                                    <a href="/team">Team</a>
                ...
                <div className="row">
                  <div className="col-lg-12">
                    <div className="tj-page-header-content text-center">
                      <h1 className="tj-page-title">Company History</h1>
                ...
                <div className="row rg-30 justify-content-between">
                  <div className="col-xl-5">
                    <div className="sec-heading mb-0">
                      <span className="sub-title wow fadeInUp" data-wow-delay="0.1s"><i className="tji-box" /> Our background
                      </span>
                      <h2 className="sec-title text-anim">
                        Discover how we have Evolved our Companyâs on <span>Legacy.</span>
                      </h2>
                    </div>
                  </div>
                  <div className="col-xl-5">
                    ...
                    <div className="history-btn mt-30 wow fadeInUp" data-wow-delay="0.5s">
                ...
                <div className="row">
                  <div className="col-12">
                    <div className="timeline">
                      <div className="timeline-inner wow fadeInUp" data-wow-delay="0.1s">
                        <div className="date">2008</div>
                        <div className="content">
                          <div className="top">
                            <span>01.</span>
                            <h4 className="title">Founding and Early Years</h4>
                            <p>Our mission is to empowers businesses off all size to thrive in an businesses ever
                              changing marketplace. We are committed to the delivering exceptional in the value.</p>
                          </div>
                      ...
                      <div className="timeline-inner wow fadeInUp" data-wow-delay="0.3s">
                      ...
                      <div className="timeline-inner wow fadeInUp" data-wow-delay="0.5s">
                        <div className="date">2016</div>
                        <div className="content">
                          <div className="top">
                            <span>03.</span>
                            <h4 className="title">Innovation and Industry Leadership</h4>
                            <p>Our mission is to empowers businesses off all size to thrive in an businesses ever
                              changing marketplace. We are committed to the delivering exceptional in the value.</p>
                          </div>
                          <div className="bottom">
                      ...
                      <div className="timeline-inner wow fadeInUp" data-wow-delay="0.7s">
                        <div className="date">2020</div>
                        <div className="content">
                          <div className="top">
                            <span>04.</span>
                            <h4 className="title">Global Expansion and Diversification</h4>
                            <p>Our mission is to empowers businesses off all size to thrive in an businesses ever
                              changing marketplace. We are committed to the delivering exceptional in the value.</p>
                          </div>
                          <div className="bottom">
                      ...
                      <div className="timeline-inner wow fadeInUp" data-wow-delay="0.9s">
                        ...
                        <div className="content">
                          ...
                          <div className="bottom">
                            ...
                            <img src="/assets/images/history/history-10.webp" alt="history" />
                          </div>
                        </div>
                      </div>
                    </div>
