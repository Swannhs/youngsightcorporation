                              ...
                              <div className=" mega-menu-pages-single">
                                <div className="mega-menu-pages-single-inner">
                                  ...
                                  <div className="mega-menu-list">
                                    ...
                                    <Link className="active" href="/wishlist">Wishlist<span className="mega-menu-badge tj-zoom-in-out-anim ">NEW</span></Link>
                ...
                <div className="row">
                  <div className="col-lg-12">
                    <div className="tj-page-header-content text-center">
                      <h1 className="tj-page-title">My wishlist</h1>
                          ...
                          <table className="woosw-items">
                            <tbody>
                              <tr className="woosw-item">
                                <td className="woosw-item--remove"><span>Ã</span></td>
                                ...
                                <td className="woosw-item--actions">
                                  ...
                                  <div className="woosw-item--atc">
                                    <p className="product woocommerce add_to_cart_inline ">
                                      <Link href="/shop-details" className="cart-button button tj-cart-btn stock-out  product_type_simple product-add-cart-btn">
