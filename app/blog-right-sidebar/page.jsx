                    ...
                    <ul>
                      ...
                      <li className="has-dropdown current-menu-ancestor"><Link href="/blog">Blog</Link>
                        <ul className="sub-menu">
                          ...
                          <li className="current-menu-item"><Link href="/blog-right-sidebar">Blog Right Sidebar</Link></li>
                      ...
                      <div className="col-md-6">
                        <div className="blog-item wow fadeInUp" data-wow-delay=".1s">
                          ...
                          <div className="blog-content">
                            ...
                            <h4 className="title"><Link href="/blog-details">Innovative Solutions for every Business
                                Success.</Link>
                            </h4>
