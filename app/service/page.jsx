                ...
                <div className="menu-area d-none d-lg-inline-flex align-items-center">
                  <nav id="mobile-menu" className="mainmenu">
                    <ul>
                            ...
                            <div className="mega-menu-wrapper">
                              ...
                              <div className="mega-menu-pages-single">
                                <div className="mega-menu-pages-single-inner">
                                  ...
                                  <div className="mega-menu-list">
                                    <Link className="active" href="/service">Services</Link>
                      ...
                      <li className="has-dropdown "><Link className="active" href="/service">Services</Link>
          ...
          <main id="primary" className="site-main">
                ...
                <div className="row">
                  <div className="col-lg-12">
                    <div className="tj-page-header-content text-center">
                      <h1 className="tj-page-title">Service</h1>
                ...
                <div className="row row-gap-4">
                  ...
                  <div className="col-lg-4 col-md-6">
                    <div className="service-item style-4 wow fadeInUp" data-wow-delay=".5s">
                      ...
                      <div className="service-content">
                        <h4 className="title"><Link href="/service-details">IT Support &amp; Maintenance</Link></h4>
                        <p className="desc">Our IT Support &amp; Maintenance services ensure that your technology infrastructure is
                  ...
                  <div className="col-lg-4 col-md-6">
                    <div className="service-item style-4 wow fadeInUp" data-wow-delay=".9s">
                      <div className="service-icon">
                        <i className="tji-service-4" />
                      </div>
                      <div className="service-content">
                  ...
                  <div className="col-lg-4 col-md-6">
                    <div className="service-item style-4 wow fadeInUp" data-wow-delay="1s">
                      ...
                      <div className="service-content">
                        ...
                        <p className="desc">Effective marketing is key to our driving business growth. Our Marketing Strategy &amp;
                          Campaigns service.</p>
                        <Link className="text-btn" href="/service-details">
                          <span className="btn-text"><span>Learn More</span></span>
                          <span className="btn-icon"><i className="tji-arrow-right-long" /></span>
            ...
            <section className="tj-pricing-section-2 section-top-gap">
              <div className="container">
                <div className="row">
                  <div className="col-12">
                    <div className="sec-heading text-center wow fadeInUp" data-wow-delay=".3s">
                      <span className="sub-title"><i className="tji-box" />Pricing plan</span>
                      <h2 className="sec-title">Our Pricing <span>Plan.</span></h2>
                    </div>
                  </div>
                </div>
                <div className="row row-gap-4">
