                ...
                <div className="row">
                  <div className="col-lg-12">
                    <div className="tj-page-header-content text-center">
                      <h1 className="tj-page-title">Team</h1>
                ...
                <div className="row">
                  <div className="col-12">
                    <div className="sec-heading text-center">
                      <span className="sub-title wow fadeInUp" data-wow-delay=".1s"><i className="tji-box" />Meet Our Team</span>
                      <h2 className="sec-title title-anim">People Behind <span>Bexon.</span></h2>
                    </div>
                  </div>
                </div>
                <div className="row">
                  ...
                  <div className="col-lg-3 col-sm-6">
                    <div className="team-item wow fadeInUp" data-wow-delay=".3s">
                      ...
                      <div className="team-content">
                        <h4 className="title"><Link href="/team-details">Savannah Ngueen</Link></h4>
                  ...
                  <div className="col-lg-3 col-sm-6">
                    <div className="team-item wow fadeInUp" data-wow-delay=".7s">
                      ...
                      <div className="team-content">
                        <h4 className="title"><Link href="/team-details">Darlene Robertson</Link></h4>
