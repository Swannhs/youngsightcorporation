                              ...
                              <div className="mega-menu-pages-single">
                                <div className="mega-menu-pages-single-inner">
                                  ...
                                  <div className="mega-menu-list">
                                    ...
                                    <Link className="active" href="/service-details">Service details</Link>
                            ...
                            <div id="faq-1" className="collapse show" data-bs-parent="#faqOne">
                              <div className="accordion-body faq-text">
                                <p>Customer Experience (CX) refers to the overall impression a customer has of a business
                                  based
                                  on their interactions across various touchpointsâwhether it's a website visit, a customer
                      ...
                      <div className="tj-post__navigation mb-0 wow fadeInUp" data-wow-delay=".3s">
                        ...
                        <div className="tj-nav__post previous">
                          <div className="tj-nav-post__nav prev_post">
                            <Link href="/service-details"><span><i className="tji-arrow-left" /></span>Previous</Link>
                          </div>
                        </div>
                        <div className="tj-nav-post__grid">
                          <Link href="/service"><i className="tji-window" /></Link>
                        </div>
                        {/* next post */}
                        <div className="tj-nav__post next">
                          <div className="tj-nav-post__nav next_post">
                            <Link href="/service-details">Next<span><i className="tji-arrow-right" /></span></Link>
                          </div>
                        </div>
                      </div>
                    </div>
                  ...
                  <div className="col-lg-4">
                    <div className="tj-main-sidebar slidebar-stickiy">
                      <div className="tj-sidebar-widget service-categories wow fadeInUp" data-wow-delay=".1s">
                        ...
                        <ul>
                          <li><Link className="active" href="/service-details">Customer Experience<span className="icon"><i className="tji-arrow-right" /></span></Link></li>
                          <li><Link href="/service-details">Training Programs<span className="icon"><i className="tji-arrow-right" /></span></Link></li>
                          <li><Link href="/service-details">Business Strategy<span className="icon"><i className="tji-arrow-right" /></span></Link></li>
                          <li><Link href="/service-details">Training Program<span className="icon"><i className="tji-arrow-right" /></span></Link></li>
                          <li><Link href="/service-details">ESG Consulting<span className="icon"><i className="tji-arrow-right" /></span></Link></li>
                          <li><Link href="/service-details">Development Hub<span className="icon"><i className="tji-arrow-right" /></span></Link></li>
                        </ul>
                      </div>
