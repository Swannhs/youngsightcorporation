                              ...
                              <div className=" mega-menu-pages-single">
                                <div className="mega-menu-pages-single-inner">
                                  ...
                                  <div className="mega-menu-list">
                                    ...
                                    <Link className="active" href="/shop-details">Shop details </Link>
                        ...
                        <div className="tj-product-details-thumb-wrapper d-flex flex-wrap flex-md-nowrap justify-content-center justify-content-md-between">
                          ...
                          <div className="tab-content tj-product-img-wrap order-1 order-md-2">
                            ...
                            <div className="tj-product-action-btn">
                              <Link className="ig-gallery" data-gall="gallery01" href="/assets/images/product/product-1.webp"><i className="tji-search" /></Link>
                              <Link className="ig-gallery" data-gall="gallery01" href="/assets/images/product/product-11.webp"><i className="tji-search" /></Link>
                              <Link className="ig-gallery" data-gall="gallery01" href="/assets/images/product/product-2.webp"><i className="tji-search" /></Link>
                            </div>
                      ...
                      <div className="col-xl-6 col-lg-6">
                        <div className="tj-product-details-wrapper">
                          ...
                          <div className="tj-product-details-action-wrapper">
                            ...
                            {/* buy now button */}
                            <Link href="/checkout" className="tj-product-details-buy-now-btn w-100">
