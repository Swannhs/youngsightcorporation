                    ...
                    <ul>
                      ...
                      <li className="has-dropdown current-menu-ancestor"><a href="/blog">Blog</a>
                        <ul className="sub-menu">
                          ...
                          <li className="current-menu-item"><a href="/blog-details">Blog Details</a></li>
                        </ul>
                      </li>
                  ...
                  <div className="col-lg-8">
                    <div className="post-details-wrapper">
                      ...
                      <div className="blog-category-two wow fadeInUp" data-wow-delay=".3s">
                        <div className="category-item">
                          ...
                          <div className="cate-text">
                            ...
                            <h6 className="title"><a href="/blog-details">Burdee Nicolas</a></h6>
                          </div>
                        </div>
                        <div className="category-item">
                      ...
                      <div className="blog-text">
                        <p className="wow fadeInUp" data-wow-delay=".3s">In todayâs competitive landscape, businesses must
                        ...
                        <blockquote className="wow fadeInUp" data-wow-delay=".3s">
                          <p>The true entrepreneur is a doer, not a dreamer. Innovation is the catalyst that transforms
                            ideas
                            into reality. In todayâs fast-paced world, success depends not on just surviving change.</p>
                        ...
                        <p className="wow fadeInUp" data-wow-delay=".3s">Unlocking your businessâs full potential is a journey
                          that
                      ...
                      <div className="tj-tags-post wow fadeInUp" data-wow-delay=".3s">
                        <div className="tagcloud">
                          <span>Tags:</span>
                          <a href="/blog">Growth</a>
                          <a href="/blog">Success</a>
                          <a href="/blog">Innovate</a>
                        </div>
                      ...
                      <div className="tj-post__navigation wow fadeInUp" data-wow-delay=".3s">
                        ...
                        <div className="tj-nav__post previous">
                          <div className="tj-nav-post__nav prev_post">
                            <a href="/blog-details"><span><i className="tji-arrow-left" /></span>Previous</a>
                          </div>
                        </div>
                        <div className="tj-nav-post__grid">
                          <a href="/blog"><i className="tji-window" /></a>
                        </div>
                        {/* next post */}
                        <div className="tj-nav__post next">
                          <div className="tj-nav-post__nav next_post">
                            <a href="/blog-details">Next<span><i className="tji-arrow-right" /></span></a>
                          </div>
                        </div>
                      </div>
                                ...
                                <div className="comment-content">
                                  ...
                                  <div className="comments-header">
                                    <div className="avatar-name">
                                      <h6 className="title">
                                        <a href="/blog-details">Great insights!</a>
                                      </h6>
                                    </div>
                                    <div className="comment-text">
                                      <span className="date">June 18, 2024 at 06:00 pm</span>
                                      <a className="reply" href="/blog-details">Reply</a>
                                    </div>
                                    <div className="desc">
                                  ...
                                  <li className="tj-comment">
                                    <div className="comment-content">
                                      ...
                                      <div className="comments-header">
                                        <div className="avatar-name">
                                          <h6 className="title">
                                            <a href="/blog-details">This was a fantastic read</a>
                                          </h6>
                                        </div>
                                        <div className="comment-text">
                                          <span className="date">June 18, 2024 at 06:00 pm</span>
