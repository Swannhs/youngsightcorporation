                ...
                <div className="menu-area d-none d-lg-inline-flex align-items-center">
                  <nav id="mobile-menu" className="mainmenu">
                    <ul>
                      ...
                      <li className="has-dropdown current-menu-ancestor"><Link href="/portfolio">Portfolio</Link>
                        <ul className="sub-menu">
                          <li><Link href="/portfolio">Portfolio</Link></li>
                          <li className="current-menu-item"><Link href="/portfolio-details">Portfolio Details</Link></li>
                        </ul>
                      </li>
                  ...
                  <div className="col-lg-8">
                    <div className="post-details-wrapper">
                      ...
                      <div className="blog-text">
                        ...
                        <p className="wow fadeInUp" data-wow-delay=".3s">In today's dynamic market, a strong and consistent
                          brand
                          ...
                          <div className="row">
                            <div className="col-sm-12">
                              <div className="image-box wow fadeInUp" data-wow-delay=".3s">
                                <Link className="gallery" data-gall="gallery" href="/assets/images/project/project-gallery-1.webp"><img src="/assets/images/project/project-gallery-1.webp" alt="Image" /></Link>
                              </div>
                            </div>
                            <div className="col-sm-6">
                              <div className="image-box wow fadeInUp" data-wow-delay=".3s">
                                <Link className="gallery" data-gall="gallery" href="/assets/images/project/project-gallery-2.webp"><img src="/assets/images/project/project-gallery-2.webp" alt="Image" /></Link>
                              </div>
                            </div>
                            <div className="col-sm-6">
                              <div className="image-box wow fadeInUp" data-wow-delay=".5s">
                                <Link className="gallery" data-gall="gallery" href="/assets/images/project/project-gallery-3.webp"><img src="/assets/images/project/project-gallery-3.webp" alt="Image" /></Link>
                              </div>
                            </div>
                          </div>
                        </div>
                      ...
                      <div className="tj-post__navigation mb-0 wow fadeInUp" data-wow-delay=".3s">
                        ...
                        <div className="tj-nav__post previous">
                          <div className="tj-nav-post__nav prev_post">
                            <Link href="/portfolio-details"><span><i className="tji-arrow-left" /></span>Previous</Link>
                          </div>
                        </div>
                        <div className="tj-nav-post__grid">
                          <Link href="/portfolio"><i className="tji-window" /></Link>
                        </div>
                        {/* next post */}
                        <div className="tj-nav__post next">
                          <div className="tj-nav-post__nav next_post">
                            <Link href="/portfolio-details">Next<span><i className="tji-arrow-right" /></span></Link>
                          </div>
                        </div>
                      </div>
                    </div>
