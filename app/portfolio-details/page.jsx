                ...
                <div className="menu-area d-none d-lg-inline-flex align-items-center">
                  <nav id="mobile-menu" className="mainmenu">
                    <ul>
                      ...
                      <li className="has-dropdown current-menu-ancestor"><a href="/portfolio">Portfolio</a>
                        <ul className="sub-menu">
                          <li><a href="/portfolio">Portfolio</a></li>
                          <li className="current-menu-item"><a href="/portfolio-details">Portfolio Details</a></li>
                        </ul>
                      </li>
                ...
                <div className="row">
                  <div className="col-lg-12">
                    <div className="tj-page-header-content text-center">
                      <h1 className="tj-page-title">Portfolio Details</h1>
                ...
                <div className="row row-gap-5">
                  <div className="col-lg-8">
                    <div className="post-details-wrapper">
                      ...
                      <h2 className="title title-anim">Designing a Modern Brand Identity for Competitive Edge</h2>
                      <div className="blog-text">
                        <p className="wow fadeInUp" data-wow-delay=".3s">Rebranding is more than just a logo change or a new
                          color
                          palette; itâs about reshaping how your
                          ...
                          audience.
                          Whether youâre launching in new markets, updating your identity for modern relevance, or simply
                        ...
                        <p className="wow fadeInUp" data-wow-delay=".3s">Our rebranding process is rooted in strategic thinking,
                          ...
                          of
                          the rebrandâ from visual design to messagingâ is authentic and impactful. The end result is a
                          refreshed brand that speaks.</p>
                        <h3 className="wow fadeInUp" data-wow-delay=".3s">Project Overview</h3>
                        <p className="wow fadeInUp" data-wow-delay=".3s">In todayâs dynamic market, a strong and consistent
                          brand
                        ...
                        <ul className="wow fadeInUp" data-wow-delay=".3s">
                          <li><span><i className="tji-check" /></span>Brand Audit &amp; Research</li>
                          <li><span><i className="tji-check" /></span>Holder &amp; Internal Communication</li>
                          <li><span><i className="tji-check" /></span>Customer Experience</li>
                          <li><span><i className="tji-check" /></span>Strategy Development</li>
                          <li><span><i className="tji-check" /></span>Launch &amp; Marketing</li>
                          <li><span><i className="tji-check" /></span>Creative Direction</li>
                          <li><span><i className="tji-check" /></span>Touchpoints</li>
                        </ul>
                        <h3 className="wow fadeInUp" data-wow-delay=".3s">Project Galley</h3>
                        <p className="wow fadeInUp" data-wow-delay=".3s">Our Rebranding Strategy for [Client Name] transformed
                          their
                          ...
                          <div className="row">
                            <div className="col-sm-12">
                              <div className="image-box wow fadeInUp" data-wow-delay=".3s">
                                <a className="gallery" data-gall="gallery" href="/assets/images/project/project-gallery-1.webp"><img src="/assets/images/project/project-gallery-1.webp" alt="Image" /></a>
                              </div>
                            </div>
                            <div className="col-sm-6">
                              <div className="image-box wow fadeInUp" data-wow-delay=".3s">
                                <a className="gallery" data-gall="gallery" href="/assets/images/project/project-gallery-2.webp"><img src="/assets/images/project/project-gallery-2.webp" alt="Image" /></a>
                              </div>
                            </div>
                            <div className="col-sm-6">
                              <div className="image-box wow fadeInUp" data-wow-delay=".5s">
                                <a className="gallery" data-gall="gallery" href="/assets/images/project/project-gallery-3.webp"><img src="/assets/images/project/project-gallery-3.webp" alt="Image" /></a>
                              </div>
                            </div>
                          </div>
                        </div>
                      ...
                      <div className="tj-post__navigation mb-0 wow fadeInUp" data-wow-delay=".3s">
                        ...
                        <div className="tj-nav__post previous">
                          <div className="tj-nav-post__nav prev_post">
                            <a href="/portfolio-details"><span><i className="tji-arrow-left" /></span>Previous</a>
                          </div>
                        </div>
                        <div className="tj-nav-post__grid">
                          <a href="/portfolio"><i className="tji-window" /></a>
                        </div>
                        {/* next post */}
                        <div className="tj-nav__post next">
                          <div className="tj-nav-post__nav next_post">
                            <a href="/portfolio-details">Next<span><i className="tji-arrow-right" /></span></a>
                          </div>
                        </div>
                      </div>
                    </div>
