                    ...
                    <ul>
                      ...
                      <li className="has-dropdown current-menu-ancestor"><Link href="/portfolio">Portfolio</Link>
                        <ul className="sub-menu">
                          <li className="current-menu-item"><Link href="/portfolio">Portfolio</Link></li>
                ...
                <div className="row">
                  <div className="col-lg-12">
                    <div className="tj-page-header-content text-center">
                      <h1 className="tj-page-title">Portfolio</h1>
                  ...
                  <div className="col-xl-4 col-md-6">
                    <div className="project-item wow fadeInUp" data-wow-delay=".3s">
                      ...
                      <div className="project-content">
                        <span className="categories"><Link href="/portfolio-details">Business</Link></span>
                        <div className="project-text">
                          <h4 className="title"><Link href="/portfolio-details">Rebranding Strategy for a Growing</Link></h4>
                          <Link className="project-btn" href="/portfolio-details">
                            <i className="tji-arrow-right-big" />
                          </Link>
                        </div>
