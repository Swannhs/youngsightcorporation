                              ...
                              <div className="mega-menu-pages-single">
                                <div className="mega-menu-pages-single-inner">
                                  ...
                                  <div className="mega-menu-list">
                                    ...
                                    <Link className="active" href="/terms-and-conditions">Term &amp; conditions</Link>
                ...
                <div className="row justify-content-center">
                  <div className="col-10">
                    <div className="terms-and-conditions-wrapper">
                      <div>
                        <h2>Terms &amp; Conditions <span className="pill">Bexon - Corporate Business HTML Template</span></h2>
                      ...
                      <div id="definitions">
                        <h3>1. Definitions</h3>
                        <p><strong>"We", "Us", "Our"</strong> refers to <em><a href="https://themeforest.net/user/theme-junction">Theme Junction</a></em>, the author of
                      ...
                      <div id="support">
                        ...
                        <p>Item support is provided in accordance with Envato's <a href="https://themeforest.net/page/item_support_policy" target="_blank" rel="noopener">Item
