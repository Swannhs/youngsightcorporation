                              ...
                              <div className=" mega-menu-pages-single">
                                <div className="mega-menu-pages-single-inner">
                                  ...
                                  <div className="mega-menu-list">
                                    ...
                                    <Link className="active" href="/cart">Cart</Link>
                ...
                <div className="row">
                  <div className="col-lg-12">
                    <div className="tj-page-header-content text-center">
                      <h1 className="tj-page-title">My cart</h1>
                                  ...
                                  <tbody>
                                    <tr className="woocommerce-cart-form__cart-item cart_item">
                                      <td className="product-thumbnail" data-title="Product">
                                        <Link href="/shop-details"><img src="/assets/images/product/product-1.webp" className="attachment-woocommerce_thumbnail size-woocommerce_thumbnail" alt="Personal holding earbud" /></Link>
                                      </td>
                                      <td className="product-name" data-title="Name">
                                        <h5><Link href="/shop-details">Personal
                                            holding earbud</Link></h5>
                                      </td>
                                      ...
                                      <td className="product-quantity tj-cart-quantity" data-title="Quantity">
                                        <div className="tj-product-quantity">
                                          <div className="quantity">
                                            ...
                                            <input type="text" className="input-text tj-cart-input qty tj-cart-input text" defaultValue={1} />
                                      ...
                                      <td className="product-remove">
                                        <Link href="#" className="remove">Ã</Link>
                                      </td>
                                    </tr>
                                    <tr className="woocommerce-cart-form__cart-item cart_item">
                                      <td className="product-thumbnail" data-title="Product">
                                        <Link href="/shop-details"><img src="/assets/images/product/product-7.webp" className="attachment-woocommerce_thumbnail size-woocommerce_thumbnail" alt="Base booster speaker" /></Link>
                                      </td>
                                      <td className="product-name" data-title="Name">
                                        <h5><Link href="/shop-details">Base
                                            booster speaker</Link></h5>
                                      </td>
                                      <td className="product-price" data-title="Price">
                                        <span className="woocommerce-Price-amount amount"><bdi><span className="woocommerce-Price-currencySymbol">$</span>200.00</bdi></span>
                                      </td>
                                      ...
                                      <td className="product-remove">
                                        <Link href="#" className="remove" aria-label="Remove this item">Ã</Link>
                                      </td>
                                    </tr>
                                    <tr className="woocommerce-cart-form__cart-item cart_item">
                                      <td className="product-thumbnail" data-title="Product">
                                        <Link href="/shop-details"><img src="/assets/images/product/product-6.webp" className="attachment-woocommerce_thumbnail size-woocommerce_thumbnail" alt="Cool mini USB fan" /></Link>
                                      </td>
                                      <td className="product-name" data-title="Name">
                                        <h5><Link href="/shop-details">Cool
                                            mini USB fan</Link></h5>
                                      </td>
                                      <td className="product-price" data-title="Price">
                                  ...
                                  <div className="row rg-30 align-items-center">
                                    <div className="col-md-8">
                                      <div className="coupon">
                                        ...
                                        <button type="submit" className="tj-primary-btn" name="apply_coupon" value="Apply coupon">
                                    ...
                                    <div className="col-md-4">
                                      <div className="tj-cart-update-btn text-md-end">
                                        <button type="submit" className="update-cart tj-primary-btn" name="update_cart" value="Update cart" disabled>
                                ...
                                <table className="shop_table shop_table_responsive">
                                  <tbody>
                                    <tr className="cart-subtotal">
                                      <th>Subtotal</th>
                                      <td data-title="Subtotal"><span className="woocommerce-Price-amount amount"><bdi><span className="woocommerce-Price-currencySymbol">$</span>450.00</bdi></span>
                                      </td>
                                    </tr>
                                    <tr className="order-total">
                                      <th>Total</th>
                                      <td data-title="Total"><strong><span className="woocommerce-Price-amount amount"><bdi><span className="woocommerce-Price-currencySymbol">$</span>450.00</bdi></span></strong>
                                      </td>
                                    </tr>
                                  </tbody>
                                </table>
                                <div className="wc-proceed-to-checkout">
                                  <Link href="/checkout" className="tj-primary-btn checkout-button button alt wc-forward">
