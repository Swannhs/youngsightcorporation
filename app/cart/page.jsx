                                  ...
                                  <tbody>
                                    <tr className="woocommerce-cart-form__cart-item cart_item">
                                      <td className="product-thumbnail" data-title="Product">
                                        <a href="/shop-details"><img src="/assets/images/product/product-1.webp" className="attachment-woocommerce_thumbnail size-woocommerce_thumbnail" alt="Personal holding earbud" /></a>
                                      </td>
                                      <td className="product-name" data-title="Name">
                                        <h5><a href="/shop-details">Personal
                                            holding earbud</a></h5>
                                      </td>
                                    ...
                                    <tr className="woocommerce-cart-form__cart-item cart_item">
                                      <td className="product-thumbnail" data-title="Product">
                                        <a href="/shop-details"><img src="/assets/images/product/product-7.webp" className="attachment-woocommerce_thumbnail size-woocommerce_thumbnail" alt="Base booster speaker" /></a>
                                      </td>
                                      <td className="product-name" data-title="Name">
                                        <h5><a href="/shop-details">Base
                                    ...
                                    <tr className="woocommerce-cart-form__cart-item cart_item">
                                      <td className="product-thumbnail" data-title="Product">
                                        <a href="/shop-details"><img src="/assets/images/product/product-6.webp" className="attachment-woocommerce_thumbnail size-woocommerce_thumbnail" alt="Cool mini USB fan" /></a>
                                      </td>
                                      <td className="product-name" data-title="Name">
                                        <h5><a href="/shop-details">Cool
                                            mini USB fan</a></h5>
                                      </td>
                                      <td className="product-price" data-title="Price">
